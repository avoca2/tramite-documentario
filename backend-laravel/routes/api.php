...
use App\Http\Controllers\Api\EstudianteAdminController; // ✅ AGREGADO
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/admin/estudiantes', [EstudianteAdminController::class, 'index']);
    Route::get('/admin/estudiantes/sin-usuario', [EstudianteAdminController::class, 'sinUsuario']);
    Route::get('/admin/estudiantes/stats', [EstudianteAdminController::class, 'stats']);
    Route::get('/admin/estudiantes/{id}', [EstudianteAdminController::class, 'show']);
    Route::post('/admin/estudiantes', [EstudianteAdminController::class, 'store']);
    Route::put('/admin/estudiantes/{id}', [EstudianteAdminController::class, 'update']);
    Route::delete('/admin/estudiantes/{id}', [EstudianteAdminController::class, 'destroy']);
});
